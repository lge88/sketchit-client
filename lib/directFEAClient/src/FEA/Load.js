		...
		display : function(renderer, scale) {
			if(!this.isShow) {
				...
				renderer.drawFilledPolygon([{
					...
					X : this.element.from.X - (this.elementAtArrowEnd ? dArrowLenX : -dArrowLenX),
					Y : this.element.from.Y - (this.elementAtArrowEnd ? dArrowLenY : -dArrowLenY),
				}, {
					X : this.element.to.X - (this.elementAtArrowEnd ? dArrowLenX : -dArrowLenX),
					Y : this.element.to.Y - (this.elementAtArrowEnd ? dArrowLenY : -dArrowLenY),
				}, {
					X : this.element.to.X,
					Y : this.element.to.Y
				}]);
