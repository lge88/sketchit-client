(function() {
	...
	myNodeOutLook = ut.extend(ut.NodeOutLook, {});
	myNode=ut.extend(ut.Node, {
		canvasElementConstructor:myNodeOutlook
	...
	myElasticBeamColumnOutlook = ut.extend(ut.ElementOutLook, {});
	myElasticBeamColumn=ut.extend(ut.ElasticBeamColumn, {
		canvasElementConstructor:myElasticBeamColumnOutlook
	});
	...
	Root = ut.extend(ut.Undoable, {
		...
		snapToNode:function(threshold){
			
		},
		snapToLine:function(threshold){
			
		},
		snapToGrid:function(dx,dy){
		...
		batchCommands : {
			...
			"node":function(){
				return this.nodes.batchAdd.apply(this,arguments);
			},
