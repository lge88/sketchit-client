...
(function(lib) {
	var Undoable = Ext.extend(Ext.util.Observable, {
...
(function(lib) {
	...
	var UndoableList = Ext.extend(lib.Undoable, {
		constructor: function(config) {
...
(function(lib) {
	var Element = Ext.extend(lib.Undoable, {})
	lib.Element=Element;
})(sketchitLib);
(function(lib) {
	var Node = Ext.extend(lib.Undoable, {})
	lib.Node=Node;
})(sketchitLib);
(function(lib) {
	/**
	...
	var Root= Ext.extend(lib.Undoable, {
		constructor: function(config) {
			this.addEvents({
				"do" : true,
				"undo" : true,
