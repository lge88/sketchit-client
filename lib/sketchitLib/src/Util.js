(function() {
	...
	Selectable = ut.extend(ObjetcHasDefault, {
		isSelected : false,
		select : function() {
	...
	Renderable = ut.extend(ObjetcHasDefault, {
		renderIndex : undefined,
		canvasElementConstructor : undefined,
		canvasElement : undefined,
	});
	canvasElement = ut.extend(ObjetcHasDefault, {
		ctx : undefined,
	...
	stroke = ut.extend(canvasElement, {
		lineWidth : 1,
	...
	strokeGroup = ut.extend(canvasElement, {
		lineWidth : 1,
		strokeStyle : [0, 0, 255, 255],
		display : function() {
	...
	filled = ut.extend(canvasElement, {
